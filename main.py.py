...
print(B+br)
print('''
[Warning! 👽This tool is not for joking or playing👽]
...
[7] 💀Destroy
    ...
    """)
    xx = int(input("👽Selected report type👽 :"))
    print('_'*30)
    print("")
    if xx == 1:
    	P1= int(input(Y+"💀 Number of reports to destroy 💀 :"))
    	tu = int(input("⏰ Waiting time not to be blocked ⏰  :"))
    	print('-'*30)
    	for i_1 in range(P1):
    	...
    	P2 = int(input(Y+"💀Number of reports to destroy💀 :"))
    	tu = int(input("⏰Waiting time not to be blocked⏰ :"))
    	print('-'*30)
    	for i_2 in range(P2):
    	...
    	P3 = int(input(Y+"💀Number of reports to destroy💀 :"))
    	tu = int(input("⏰Waiting time not to be blocked⏰  :"))
    	print('-'*30)
    	for i_3 in range(P3):
    	...
    	P4 = int(input(Y+"💀Number of reports to destroy💀 :"))
    	tu = int(input("⏰Waiting time not to be blocked⏰  :"))
    	print('-'*30)
    	for i_4 in range(P4):
    	...
    	P5 = int(input(Y+"💀Number of reports to destroy💀 :"))
    	tu = int(input("⏰Waiting time not to be blocked⏰  :"))
    	print('-'*30)
    	for i_5 in range(P5):
    	...
    	P6 = int(input(Y+"💀Number of reports to destroy💀 :"))
    	tu = int(input("⏰Waiting time not to be blocked⏰  :"))
    	print('-'*30)
    	for i_6 in range(P6):
    	...
    	P7 = int(input(Y+"💀Number of reports to destroy💀 :"))
    	tu = int(input("⏰Waiting time not to be blocked⏰  :"))
    	print('-'*30)
    	for i_7 in range(P7):
